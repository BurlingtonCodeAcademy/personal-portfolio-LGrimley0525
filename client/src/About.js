...
import Homephoto from './websitephotos/Homephoto.png'
import './App.css'
    ...
    return (
        <div className='about'>
            ...
            <div id='about-text'>
                ...
                < hr />
                <p>I am currently enrolled at Burlington Code Academy in the Software Development Bootcamp, with an anticipated completion date of April 24, 2020.<br />
                </p>
                <p>Like many, I was unhappy with the work I was doing, and left feeling unfulfilled.  I decided to take a stand and made the decision to enroll at BCA leading to a major shift in my career trajectory.  At BCA, I am studying software development and building full stack web applications with JavaScript, incorporating ReactJS as well. Very quickly on, I realized that the technology field was where I was meant to be. <br /> 
                </p>
